...
import 'package:quizpro/view/result_screen/social_result.dart';

class SocialQuiz extends StatefulWidget {
  const SocialQuiz({super.key});

  @override
  State<SocialQuiz> createState() => _SocialQuizState();
}
...
class _SocialQuizState extends State<SocialQuiz> {
  ...
  int questIndex = 0;
  int currentQuest = 1;
  int lastQuest = Dummydb.socialQuestionList.length;
  int? selectedOption;
            ...
            children: [
                  ...
                  children: [
                    SizedBox(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            Dummydb.socialQuestionList[questIndex]["question"],
                            style: TextStyle(color: ColorConstants.TextColor),
                          ),
                        ),
                      ),
                    ...
                    if (selectedOption ==
                        Dummydb.socialQuestionList[currentIndex]["answerIndex"])
                      Lottie.asset(
              ...
              Column(
                children: List.generate(
                  Dummydb.socialQuestionList[currentIndex]["options"].length,
                  (optionIndex) {
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (!_isAnswered) {
                            ...
                            if (selectedOption ==
                                Dummydb.socialQuestionList[currentIndex]
                                    ["answerIndex"]) {
