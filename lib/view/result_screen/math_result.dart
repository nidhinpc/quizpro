...
class MathResult extends StatefulWidget {
  const MathResult({required this.rightAnswerCount, super.key});

  final int rightAnswerCount;

  @override
  State<MathResult> createState() => _MathResultState();
}
...
class _MathResultState extends State<MathResult> {
  ...
  calculateStarccount() {
    var percentage =
        widget.rightAnswerCount / Dummydb.mathsQuestionList.length * 100;
    if (percentage >= 80) {
      starCount = 3;
