...
import 'package:quizpro/view/result_screen/chemistry_result.dart';
...
class _ChemistryQuizState extends State<ChemistryQuiz> {
  ...
  int questIndex = 0;
  int currentQuest = 1;
  int lastQuest = Dummydb.chemistryQuestionList.length;
  int? selectedOption;
            ...
            children: [
                  ...
                  children: [
                    SizedBox(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            Dummydb.chemistryQuestionList[questIndex]
                                ["question"],
                            style: TextStyle(color: ColorConstants.TextColor),
                          ),
                        ),
                    ...
                    if (selectedOption ==
                        Dummydb.chemistryQuestionList[currentIndex]
                            ["answerIndex"])
                      Lottie.asset(
              ...
              Column(
                children: List.generate(
                  Dummydb.chemistryQuestionList[currentIndex]["options"].length,
                  (optionIndex) {
                    return Padding(
  ...
  Color getColor(int currentOptionIndex) {
    if (selectedOption != null &&
        currentOptionIndex ==
            Dummydb.chemistryQuestionList[currentIndex]["answerIndex"]) {
