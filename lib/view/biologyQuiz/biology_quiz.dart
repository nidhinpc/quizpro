...
class _BiologyQuizState extends State<BiologyQuiz> {
  ...
  int questIndex = 0;
  int currentQuest = 1;
  int lastQuest = Dummydb.biologyQuestionList.length;
  int? selectedOption;
            ...
            children: [
                  ...
                  children: [
                    SizedBox(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            Dummydb.biologyQuestionList[questIndex]["question"],
                            style: TextStyle(color: ColorConstants.TextColor),
                          ),
                        ),
                      ),
              ...
              Column(
                children: List.generate(
                  Dummydb.biologyQuestionList[currentIndex]["options"].length,
                  (optionIndex) {
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (!_isAnswered) {
                            ...
                            if (selectedOption ==
                                Dummydb.biologyQuestionList[currentIndex]
                                    ["answerIndex"]) {
  ...
  Color getColor(int currentOptionIndex) {
    if (selectedOption != null &&
        currentOptionIndex ==
            Dummydb.biologyQuestionList[currentIndex]["answerIndex"]) {
